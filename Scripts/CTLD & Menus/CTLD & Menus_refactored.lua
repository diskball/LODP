...
local UNIT_CONFIG = {
    { id = "MANPADS",        menuName = "MANPADS",        ctldName = "Anti-Air",       type = CTLD_CARGO.Enum.TROOPS,  redGroup = "AAR",                blueGroup = "AAB",                 size = 1, mass = 90,   subcategory = "SHORAD",       cost = 100 },
    ...
    { id = "Shilka",         menuName = "Shilka",         ctldName = "Shilka",         type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED Shilka",         blueGroup = "BLUE Shilka",         size = 1, mass = 1000, subcategory = "SHORAD",       cost = 180 },
    { id = "Chaparral",      menuName = "Chaparral",      ctldName = "Chaparral",      type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED Chaparral",      blueGroup = "BLUE Chaparral",      size = 1, mass = 1000, subcategory = "SHORAD",       cost = 200 },
    ...
    { id = "SA19",           menuName = "SA-19",          ctldName = "SA-19",          type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA19",           blueGroup = "BLUE SA19",           size = 1, mass = 1000, subcategory = "SHORAD",       cost = 350 },
    { id = "SA13",           menuName = "SA-13",          ctldName = "SA-13",          type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA13",           blueGroup = "BLUE SA13",           size = 1, mass = 1000, subcategory = "SHORAD",       cost = 400 },
    { id = "SA8",            menuName = "SA-8",           ctldName = "SA-8",           type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA8",            blueGroup = "BLUE SA8",            size = 1, mass = 1000, subcategory = "SHORAD",       cost = 400 },
    { id = "SA6",            menuName = "SA-6",           ctldName = "SA-6",           type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA6",            blueGroup = "BLUE SA6",            size = 2, mass = 1000, subcategory = "SAM",       cost = 800 },
    { id = "C-RAM",         menuName = "C-RAM",          ctldName = "C-RAM",          type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED C-RAM",          blueGroup = "BLUE C-RAM",          size = 2, mass = 1000, subcategory = "SHORAD",       cost = 2000 },
    { id = "SA15M1",         menuName = "SA-15M1",        ctldName = "SA-15M1",        type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA15M1",         blueGroup = "BLUE SA15M1",         size = 2, mass = 1000, subcategory = "SHORAD",       cost = 1550 },
    { id = "SA15M2",         menuName = "SA-15M2",        ctldName = "SA-15M2",        type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA15M2",         blueGroup = "BLUE SA15M2",         size = 3, mass = 1000, subcategory = "SAM",       cost = 4000 }, 
    { id = "HAWK",         menuName = "HAWK",        ctldName = "HAWK",        type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED HAWK",         blueGroup = "BLUE HAWK",         size = 3, mass = 1000, subcategory = "SAM",       cost = 3500 },
    { id = "SA-11",         menuName = "SA-11",        ctldName = "SA-11",        type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA11",         blueGroup = "BLUE SA11",         size = 3, mass = 1000, subcategory = "SAM",       cost = 4500 },
    { id = "SBORKA",            menuName = "SBORKA",            ctldName = "SBORKA",            type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SBORKA",            blueGroup = "BLUE SBORKA",            size = 1, mass = 1000, subcategory = "EWR",       cost = 150 },
    { id = "EWR",            menuName = "EWR",            ctldName = "EWR",            type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED EWR",            blueGroup = "BLUE EWR",            size = 1, mass = 1000, subcategory = "EWR",       cost = 550 },
    { id = "SA10",           menuName = "SA-10",          ctldName = "SA-10",          type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA10",           blueGroup = "BLUE SA10",           size = 4, mass = 1000, subcategory = "SAM",       cost = 8000 },
