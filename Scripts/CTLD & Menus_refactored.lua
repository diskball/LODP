...
local UNIT_CONFIG = {
    { id = "MANPADS",  menuName = "MANPADS",  ctldName = "Anti-Air", type = CTLD_CARGO.Enum.TROOPS,  redGroup = "AAR",       blueGroup = "AAB",        size = 2, time = 90,   mass = 0, cost = 100 },
    { id = "Infantry", menuName = "Infantry", ctldName = "Infantry", type = CTLD_CARGO.Enum.TROOPS,  redGroup = "RIFLER",    blueGroup = "RIFLEB",     size = 6, time = 90,   mass = 0, cost = 50  },
    { id = "Scout",    menuName = "M-113",    ctldName = "M-113",    type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SCOUT", blueGroup = "BLUE SCOUT", size = 1, time = 1000, mass = 0, cost = 150 },
    { id = "Leopard",  menuName = "Leopard",  ctldName = "Leopard",  type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED TANK",  blueGroup = "BLUE TANK",  size = 2, time = 1000, mass = 0, cost = 250 },
    { id = "SA13",      menuName = "SA-13",     ctldName = "SA-13",     type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA13",   blueGroup = "BLUE SA13",   size = 2, time = 1000, mass = 0, cost = 300 },
    { id = "SA8",      menuName = "SA-8",     ctldName = "SA-8",     type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA8",   blueGroup = "BLUE SA8",   size = 2, time = 1000, mass = 0, cost = 300 },
    { id = "SA15M1",   menuName = "SA-15M1",  ctldName = "SA-15M1",  type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA15M1", blueGroup = "BLUE SA15M1",  size = 2, time = 1000, mass = 0, cost = 350 },
    { id = "SA15M2",   menuName = "SA-15M2",  ctldName = "SA-15M2",  type = CTLD_CARGO.Enum.VEHICLE, redGroup = "RED SA15M2", blueGroup = "BLUE SA15M",  size = 2, time = 1000, mass = 0, cost = 500 },
...
local function configureCTLD(coalitionSide, cargoPrefix)
    ...
    for _, chop in ipairs(CHOPPER_CONFIG) do
        ctldInstance:SetUnitCapabilities(chop.type, chop.sling, chop.crates, chop.maxCrates, chop.maxTroops, chop.length, chop.mass)
    end
...
local function buildMenus(coalitionSide, sideName, ctldInstance)
    ...
    MENU_COALITION_COMMAND:New(coalitionSide, "Show Available Budget", bankMenu, displayBankBalance, coalitionSide, sideName)
    
    local suppliesMenu = MENU_COALITION:New(coalitionSide, "Buy CTLD Crates", mainMenu)
    
    for _, unit in ipairs(UNIT_CONFIG) do
        local buyMenu = MENU_COALITION:New(coalitionSide, "Buy " .. unit.menuName .. " ("..unit.cost..")", suppliesMenu)
        MENU_COALITION_COMMAND:New(coalitionSide, "Complete Purchase", buyMenu, buyUnit, coalitionSide, sideName, ctldInstance, unit)
    end
end
